...
export const metadata: Metadata = {
    ...
    description: "Privacy policy and data protection information for Epi FlipBoard users.",
};
            ...
            <div className="prose prose-gray max-w-none space-y-8">
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Welcome to Epi FlipBoard ("we," "our," or "us"). We are committed to protecting your personal data and respecting your privacy.
                ...
                <section>
                    ...
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">2.1 Personal Data</h3>
                    <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">4. Cookies and Tracking Technologies</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        Cookies are small data files stored on your device that help us improve functionality and analyze site usage.
                    </p>

                    <h3 className="text-xl font-semibold text-gray-800 mb-3">4.1 Types of Cookies We Use</h3>
                    <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        You can control cookie settings through your browser preferences. However, disabling certain cookies may affect your ability to use some features of our website.
                    </p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">5. Data Sharing and Disclosure</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">6. Your Rights Under GDPR</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">7. Data Security</h2>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">8. Data Retention</h2>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">9. Third-Party Links</h2>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">10. Children's Privacy</h2>
                    <p className="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">11. International Data Transfers</h2>
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        transfer of your information to these locations, where we will take appropriate measures to ensure your data is
                        protected in accordance with this Privacy Policy.
                    </p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">12. Changes to This Privacy Policy</h2>
                    <p className="text-gray-700 leading-relaxed">
                        We may update this Privacy Policy from time to time to reflect changes in our practices or for legal, operational,
                        or regulatory reasons. We will notify you of any material changes by posting the updated policy on this page with a
                        new "Last updated" date. Your continued use of our services after such changes constitutes acceptance of the updated policy.
                    </p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-4">13. Contact Us</h2>
                    <p className="text-gray-700 leading-relaxed mb-4">
                        If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us at:
                    </p>
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                        <p className="text-gray-700"><strong>Epi FlipBoard</strong></p>
                        <p className="text-gray-700">Email: privacy@kelps.org</p>
                    </div>
                </section>
            </div>
        </div>
