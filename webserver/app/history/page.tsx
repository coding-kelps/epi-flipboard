    ...
    if (!isAuthenticated) {
        return (
            <div className="container mx-auto px-4 py-12 flex flex-col items-center justify-center text-center gap-4">
                ...
                <h1 className="text-2xl font-serif font-bold text-gray-900">Sign in to view your history</h1>
                <p className="text-gray-600 max-w-md">
                    Keep track of stories you've read and easily find them later.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="flex items-center gap-3 mb-8 border-b border-gray-100 pb-4">
                ...
                <h1 className="text-3xl font-serif font-bold text-gray-900">Reading History</h1>
            </div>
            ...
            {isLoading && articles.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center text-gray-500">
                    <p className="text-lg font-serif">You haven't read any articles yet.</p>
                    <p className="text-sm mt-2">Stories you open will appear here.</p>
                </div>
            ) : (
