            ...
            <div className="prose prose-gray max-w-none space-y-8">
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        Welcome to Epi FlipBoard. By accessing or using our
                        website and services, you agree to be bound by these
                        Terms of Service (&quot;Terms&quot;). If you do not
                        agree to these Terms, please do not use our services. We
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Epi FlipBoard is a news aggregation and content
                        discovery platform that provides users with curated
                        articles, news stories, and other content from various
                        sources. Our service allows you to:
                    </p>
                    <ul className="list-disc pl-6 text-gray-700 space-y-2">
                        <li>Browse and read articles from multiple sources</li>
                        <li>
                            Create a personalized account to save preferences
                        </li>
                        <li>Search for specific topics and content</li>
                        <li>
                            Access content across different categories and
                            sources
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        required to create an account. When creating an account,
                        you agree to:
                    </p>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        appropriate. You may also delete your account at any
                ...
                <section>
                    ...
                    <ul className="list-disc pl-6 text-gray-700 space-y-2">
                        ...
                        <li>
                            Post or transmit harmful, offensive, or illegal
                            content
                        </li>
                        <li>
                        ...
                        <li>
                            Engage in any activity that could harm, disable, or
                            impair the service
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        All content, features, and functionality of Epi
                        FlipBoard, including but not limited to text, graphics,
                        logos, icons, images, audio clips, software, and the
                        compilation thereof (collectively, &quot;Content&quot;),
                        are the exclusive property of Epi FlipBoard or its
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        Articles and content displayed on our platform are
                        sourced from third-party publishers and content
                        providers. We do not claim ownership of this third-party
                        content, and all rights remain with the respective
                        copyright holders.
                    </p>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        non-commercial purposes. You may not reproduce,
                        distribute, modify, create derivative works, publicly
                        display, or exploit any Content without our express
                        written permission.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        practices of any third-party sites or services. You
                        acknowledge and agree that we shall not be responsible
                        or liable for any damage or loss caused by your use of
                        such third-party content or services.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        will be uninterrupted, secure, or error-free. We reserve
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        any content displayed on our service. Third-party
                        content is provided by external sources, and we are not
                        responsible for errors or omissions in such content.
                    </p>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        To the fullest extent permitted by law, Epi FlipBoard
                        ...
                        intangible losses resulting from your use of or
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        You agree to indemnify, defend, and hold harmless Epi
                        FlipBoard and its affiliates, officers, directors,
                        ...
                        your use of the service, your violation of these Terms,
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        to our collection and use of your data as described in
                        the Privacy Policy.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        You agree to waive any right to a jury trial or to
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        shall continue in full force and effect. The invalid
                        provision shall be modified to the minimum extent
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        other legal notices or agreements published on the
                        service, constitute the entire agreement between you and
                        Epi FlipBoard regarding your use of the service and
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        any time at our sole discretion. Material changes will
                        be effective upon posting to this page with an updated
                        &quot;Last updated&quot; date. Your continued use of the
                        service after any changes constitutes acceptance of the
                        new Terms. We encourage you to review these Terms
                        periodically.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        ...
                        contact us at terms@epi-flipboard.com.
                    </p>
