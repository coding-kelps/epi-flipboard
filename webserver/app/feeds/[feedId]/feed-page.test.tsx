...
describe('FeedPage', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks()
        ;(prismaLib.getPrismaActivity as any).mockReturnValue(
            mockPrismaActivity
        )
    ...
    const mockPublishers = [
        { publisher_id: 1n, display_name: 'Pub1', name: 'Pub1' },
    ]
    ...
    it('shows empty state if no articles', async () => {
        ...
        expect(
            screen.getByText('No articles found for these tags yet.')
        ).toBeInTheDocument()
    })
