    ...
    return {
        ...
        getPrismaContent: vi.fn(() => ({
            tags: {
                findMany: vi
                    .fn()
                    .mockResolvedValue([{ tag_id: 1n, name: 'Tag1' }]),
            },
            publishers: {
                findMany: vi
                    .fn()
                    .mockResolvedValue([{ publisher_id: 1n, name: 'Pub1' }]),
            },
        })),
    }
})
...
vi.mock('@/components/FeedsClientWrapper', () => ({
    default: () => <div data-testid="feeds-client-wrapper" />,
}))
...
describe('Feed Pages', () => {
    ...
    describe('My Feeds Page', () => {
        it('renders FeedsClientWrapper with user feeds', async () => {
            ...
            expect(
                screen.getByTestId('feeds-client-wrapper')
            ).toBeInTheDocument()
    ...
    describe('Feed Detail Page', () => {
        ...
        it('calls notFound if invalid ID', async () => {
            ...
            await expect(
                FeedPage({ params: Promise.resolve({ feedId: 'abc' }) })
