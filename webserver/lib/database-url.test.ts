...
describe('database-url', () => {
    ...
    it('builds URL correctly', () => {
        ...
        expect(url).toBe('postgresql://user:pass@localhost:5432/testdb?sslmode=require');
    });
    ...
    it('throws if required env var missing', () => {
        ...
        expect(() => getDatabaseUrl('TEST_DB_2')).toThrow('Missing required environment variable: TEST_DB_2_NAME');
    });
