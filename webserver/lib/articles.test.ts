...
describe('articles.ts', () => {
    ...
    describe('getArticles', () => {
        it('should fetch articles and enrich them', async () => {
            mockPrismaContentValues.articles.findMany.mockResolvedValue([
                mockArticle,
            ])
        ...
        it('should handle errors gracefully', async () => {
            mockPrismaContentValues.articles.findMany.mockRejectedValue(
                new Error('DB Error')
            )
        ...
        it('should check for saved articles if userId is provided', async () => {
            ...
            expect(
                mockPrismaActivityValues.markedArticle.findMany
    ...
    describe('searchArticles', () => {
        it('should search articles by query', async () => {
            ...
            expect(
                mockPrismaContentValues.articles.findMany
            ).toHaveBeenCalledWith(
                expect.objectContaining({
