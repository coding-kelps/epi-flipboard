    ...
    return (
        <Link href={href} onClick={handleClick} className="group block">
            <article className="flex flex-col gap-2 py-4 border-b border-gray-200 last:border-0 relative overflow-hidden">
                <div className={cn("relative w-full aspect-video mb-1 overflow-hidden flex items-center justify-center rounded-sm", colorClass)}>
                    <Icon className={cn("w-12 h-12 transition-transform duration-500 group-hover:scale-110", iconClassName || "text-gray-700")} />
                </div>
