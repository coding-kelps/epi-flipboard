...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::minutes(20)).naive_utc()),
            ..Default::default()
        };
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(3)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(6)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(9)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(11)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(30)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(40)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(50)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
        ...
        let article = article::ActiveModel {
            ...
            published_at: Set((now - Duration::hours(62)).naive_utc()),
            ..Default::default()
        };
        article::Entity::insert(article).exec(db).await?;
